...
#define __OPC_RAYCOLLIDER_H__
	...
	class RayCollider : public Collider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(const Ray& world_ray, const Model& model, const Matrix4x4* world=null, unsigned int* cache=null);
		//
...
#ifdef OPC_RAYHIT_CALLBACK
		inline				void			SetHitCallback(HitCallback cb)			{ mHitCallback	= cb;			}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline				unsigned int			GetNbRayBVTests()				const	{ return mNbRayBVTests;		}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline				unsigned int			GetNbRayPrimTests()				const	{ return mNbRayPrimTests;	}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline				unsigned int			GetNbIntersections()			const	{ return mNbIntersections;	}
...
#endif
		// Stats
							unsigned int			mNbRayBVTests;		//!< Number of Ray-BV tests
							unsigned int			mNbRayPrimTests;	//!< Number of Ray-Primitive tests
		// In-out test
							unsigned int			mNbIntersections;	//!< Number of valid intersections
		...
		inline				BOOL			RayTriOverlap(const Point& vert0, const Point& vert1, const Point& vert2);
			// Init methods
							BOOL			InitQuery(const Ray& world_ray, const Matrix4x4* world=null, unsigned int* face_id=null);
	};
